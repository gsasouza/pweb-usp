...
const updateCount = () => countParagraph.textContent = `Ball count: ${balls.filter(ball => ball.exists).length}`;
...
EvilCircle.prototype.setControls = function() {
  window.onkeydown = (e) => {
    switch (e.code) {
      case 'KeyA': return this.x -= this.velX;
      case 'KeyD': return this.x += this.velX;
      case 'KeyW': return this.y -= this.velY;
      case 'KeyS': return this.y += this.velY;
    }
  };
};
